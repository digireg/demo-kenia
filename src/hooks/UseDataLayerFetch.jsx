...
// import { useState, useEffect } from "react";
// import { DataLayerCreate } from "../components/DataLayerCreate";
// import { DataLayerCreateWMTS } from "../components/DataLayerCreateWMTS";
// import { DATASET_CONFIG } from "../config/datasetConfig";
...
//             if (Array.isArray(config.children) && config.children.length > 0) {
//               // Use hardcoded children if available
//               children = addKeysRecursively(
//                 config.children.map((child) => ({
//                   ...child,
//                   opacity: child.opacity ?? 100,
...
//               // Fetch WMS layers
//               children = await DataLayerCreate(
//                 `${config.url}SERVICE=WMS&REQUEST=GetCapabilities`,
//                 groupId
//               );
//               children = addKeysRecursively(children, groupId);
//             } else if (config.type === "wmts") {
//               // Fetch WMTS layers
//               children = await DataLayerCreateWMTS(
//                 `${config.url}SERVICE=WMTS&REQUEST=GetCapabilities`,
//                 groupId
//               );
//               children = addKeysRecursively(children, groupId);
//             }
